...
loot_types ={				1:[
							...
							["contents ","fluid",1,20,['fluid'],None,None]],
							2],
							7:[
							'Kids Shovel ',
							['kshovel'],
							...
							["contents ","fluid",1,30,['fluid'],None,None]],
							8],
							11:[
							'Purse ',
							['purse'],
							...
							["cap ","chunk ",1,1,['plastic'],None,None],
							["contents ","fluid",1,100,['fluid'],None,None]],
							2],
							15:[
							'Charcoal Barbecue ',
							['bbq'],
							...
							["contents ","chunk ",1,3,['mineral'],None,None]],
							15],
							16:[
							'Jerry Can ',
							['jcan'],
							...
							[["body ","sheet ",1,4,['plastic'],None,None],
							["cap ","chunk ",1,1,['plastic'],None,None],
							["contents ","pills",1,100,['pills'],None,None]],
							.5],
							18:[
							'Pill Bottle ',
							['pillbottle'],
							...
							["contents ","fluid",1,5,['fluid'],None,None]],
							.2],
							21:[
							'Bowl ',
							['bowl'],
							...
							'Cookie Tin ',
							['cookietin'],
							[["tin ","sheet ",1,5,['paper'],None,None],
							["lid ","sheet ",1,1,['paper'],None,None],
							["contents ","pills",1,30,['pills'],None,None]],
							.8],
							24:[
							'Dish Detergent ',
							['dishdetergent'],
							...
							[["body ","sheet ",1,4,['plastic'],None,None],
							["cap ","chunk ",1,1,['plastic'],None,None],
							["contents ","fluid",1,50,['fluid'],None,None]],
							1.2],
							29:[
							'Noodle Cup ',
							['noodlecup'],
							...
							["contents ","pills",1,200,['pills'],None,None]],
							.2],
							30:[
							'Patio Chair ',
							['patiochair'],
							...
							["back ","sheet ",1,3,['pills','metal','wood'],None,None],
							...
							["lid ","chunk ",1,1,['plastic'],None,None],
							["contents ","fluid",1,200,['fluid'],None,None]],
							.3],
							35:[
							'Toaster ',
							['toaster'],
